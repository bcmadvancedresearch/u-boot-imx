...
static iomux_v3_cfg_t const ar8mxm_gpio_pads[] = {
	IMX8MQ_PAD_GPIO1_IO11__GPIO1_IO11 | MUX_PAD_CTRL(NO_PAD_CTRL),		/* USB30PW_EN */
	IMX8MQ_PAD_SPDIF_TX__GPIO5_IO3 | MUX_PAD_CTRL(NO_PAD_CTRL),
	//IMX8MQ_PAD_SAI1_TXC__GPIO4_IO11 | MUX_PAD_CTRL(NO_PAD_CTRL),
	//IMX8MQ_PAD_SAI5_RXD0__GPIO3_IO21 | MUX_PAD_CTRL(NO_PAD_CTRL),
	IMX8MQ_PAD_SAI3_RXC__GPIO4_IO29 | MUX_PAD_CTRL(NO_PAD_CTRL),		/* M2B_nRST */
	IMX8MQ_PAD_SAI3_RXFS__GPIO4_IO28 | MUX_PAD_CTRL(NO_PAD_CTRL),		/* M2B_nDIS */
};

static void ar8mxm_gpio_init(void)
{
	imx_iomux_v3_setup_multiple_pads(ar8mxm_gpio_pads,
					 ARRAY_SIZE(ar8mxm_gpio_pads));

	gpio_request(IMX_GPIO_NR(1, 11), "usb30pw_en");
	gpio_direction_output(IMX_GPIO_NR(1, 11), 1);

	gpio_request(IMX_GPIO_NR(5, 3), "l0_pwren");
	gpio_direction_output(IMX_GPIO_NR(5, 3), 1);

	//gpio_request(IMX_GPIO_NR(4, 11), "lvds_sel68");
	//gpio_direction_output(IMX_GPIO_NR(4, 11), 0);

	//gpio_request(IMX_GPIO_NR(3, 21), "dsi85_reset");
	//gpio_direction_output(IMX_GPIO_NR(3, 21), 0);

	/* For M.2 EM7355 */
	gpio_request(IMX_GPIO_NR(4, 28), "M2B_nDIS");
	gpio_direction_output(IMX_GPIO_NR(4, 28), 1);
	gpio_request(IMX_GPIO_NR(4, 29), "M2B_nRST");
...
#define FEC_RST_PAD IMX_GPIO_NR(3, 22)
static iomux_v3_cfg_t const fec1_rst_pads[] = {
	IMX8MQ_PAD_SAI5_RXD1__GPIO3_IO22 | MUX_PAD_CTRL(NO_PAD_CTRL),
};

static void setup_iomux_fec(void)
{
#if 0 /* didn't use ENET_nRST */
	imx_iomux_v3_setup_multiple_pads(fec1_rst_pads,
					 ARRAY_SIZE(fec1_rst_pads));

	gpio_request(IMX_GPIO_NR(3, 22), "fec1_rst");
